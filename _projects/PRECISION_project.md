...
img: assets/img/projects/PRECISION_short.png
importance: 1
category: national
---
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/projects/MICIU+Cofinanciado+AEI.jpg" title="PRECISION project funding" class="img-fluid rounded z-depth-1" %}
    </div>
</div>